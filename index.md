...
I’m trained as a combination of applied econometrician and data scientist. My current research leverages unstructured data such as video (image, audio and text), map and network and combines tools in causal inference (both experimental and observational) and machine learning to optimize marketing decisions. I’m also interested in understanding consumer behaviors through the lens of basic economic and psychological principles.
