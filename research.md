...
My research is motivated by a central question: How do creators, brands, and platforms better engage and monetize users? This question concerns the process of producing compelling content to captivate an audience, fostering communities to enhance engagement, and monetizing through advertising or product sales. I develop or use empirical methods in machine learning, field and lab experiments, and econometrics to address this question by analyzing large-scale multimodal data. 
