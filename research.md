...
My dissertation is on learning to design, deliver, and diffuse marketing interventions. I'm affiliated with the [Initiative on the Digital Economy](http://ide.mit.edu), [Social Analytics Lab](https://www.sinanaral.io/research/lab), [Behavioral Research Lab](https://brl.mit.edu) at MIT, the [Harvard Data Science Initiative](https://datascience.harvard.edu/) and the [American Statistical Association](https://www.amstat.org/).
